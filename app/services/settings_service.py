...
_DEFAULTS: dict[str, Any] = {
    ...
    "camera_width": 3840,       # 4K UHD @ 15fps: the Pi 5 encodes H.264 in
    "camera_height": 2160,      # software, so 4K@30 pegs the CPU/adds lag; 15fps
    "camera_fps": 15,           # halves the load for a much snappier mirror.
