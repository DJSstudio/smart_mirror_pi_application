...
_DEFAULTS: dict[str, Any] = {
    ...
    "camera_width": 2560,       # 2K/QHD @ 30fps: ~44% of 4K's pixels, so the
    "camera_height": 1440,      # Pi 5's software H.264 encoder sustains 30fps
    "camera_fps": 30,           # (snappier mirror) while staying sharper than
    "camera_bitrate": 12_000_000,  # 1080p and oversampling the 1080p mirror.
    # Recording
    "countdown_seconds": 3,
    # Mirror
